...
export const dict: { en: Record<string, string>; kk: Record<string, string> } = {
  en: {
    ...
    "Оперкарточка в руках у РТП, расстановка сил на поэтажном плане, расчёт сил и средств по методике ДЧС, электронное донесение.": "The operational card in the incident commander's hands, crew placement on the floor plan, force-and-means calculation per the emergency service methodology, and an electronic report.",
  ...
  kk: {
    ...
    "Оперкарточка в руках у РТП, расстановка сил на поэтажном плане, расчёт сил и средств по методике ДЧС, электронное донесение.": "Жедел карта ӨСБ қолында, күштерді қабат жоспарында орналастыру, ТЖД әдістемесі бойынша күштер мен құралдарды есептеу, электронды баянат.",
