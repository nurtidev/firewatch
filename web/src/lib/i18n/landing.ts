...
export const dict: { en: Record<string, string>; kk: Record<string, string> } = {
  en: {
    ...
    "Данные в РК": "Data hosted in Kazakhstan",
    ...
    "Журнал аудита, маскирование ПДн, данные в РК": "Audit log, PII masking, data hosted in Kazakhstan",
    ...
    "Аудит ПБ, план эвакуации и 2D/3D-планы": "Fire-safety audit, evacuation plan and 2D/3D plans",
    ...
    "Предиктивная пожарная безопасность · ДЧС РК · Астана": "Predictive fire safety · ESD RK · Astana",
    ...
    "Хранение и обработка на инфраструктуре в Казахстане, доступ разграничен по ролям и районам.":
      "Storage and processing on infrastructure in Kazakhstan, access is scoped by role and district.",
    ...
    "Не папка бумаг, а объект в портале: аудит ПБ, план эвакуации, 2D/3D-планы и предиктивная риск-оценка. Конкуренты в РК делают это вручную — мы быстрее, нагляднее и с аналитикой, которой нет ни у кого.":
      "Not a folder of papers, but a facility in a portal: fire-safety audit, evacuation plan, 2D/3D plans and a predictive risk score. Competitors in Kazakhstan do this by hand — we're faster, clearer, and offer analytics nobody else has.",
    ...
    "Аудит пожарной безопасности и план эвакуации": "Fire-safety audit and evacuation plan",
    ...
    "Обсудить оцифровку вашего объекта": "Discuss digitizing your facility",
    ...
    "Аудит ПБ, документы и планы эвакуации без недель ручной работы подрядчика.":
      "Fire-safety audit, documents and evacuation plans, without weeks of a contractor's manual work.",
    ...
    "Цифровой паспорт закрывает первопричину: аудит находит нарушения до пожара, а риск-оценка показывает, какие объекты и системы требуют внимания в первую очередь.":
      "The digital passport addresses the root cause: the audit finds violations before a fire, and the risk score shows which facilities and systems need attention first.",
    ...
    "Аудит ПБ + план эвакуации + 2D/3D-планы + риск-оценка объекта.":
      "Fire-safety audit + evacuation plan + 2D/3D plans + facility risk score.",
    ...
    // ── "/login" ───────────────────────────────────────────────────────────
    "Предиктивная платформа · ДЧС РК": "Predictive platform · ESD RK",
    "Логин": "Username",
    ...
    "Не папка бумаг, а объект в портале: аудит ПБ, план эвакуации, 2D/3D-планы и риск-оценка, которой нет ни у кого.":
      "Not a folder of papers, but a facility in a portal: fire-safety audit, evacuation plan, 2D/3D plans and a risk score nobody else offers.",
  ...
  kk: {
    ...
    "Данные в РК": "Деректер ҚР аумағында",
    ...
    "Журнал аудита, маскирование ПДн, данные в РК": "Аудит журналы, ДД бүркемелеу, деректер ҚР аумағында",
    ...
    "Аудит ПБ, план эвакуации и 2D/3D-планы": "ӨҚ аудиті, эвакуация жоспары және 2D/3D жоспарлар",
    ...
    "Предиктивная пожарная безопасность · ДЧС РК · Астана": "Болжамды өрт қауіпсіздігі · ҚР ТЖД · Астана",
    ...
    "Хранение и обработка на инфраструктуре в Казахстане, доступ разграничен по ролям и районам.":
      "Сақтау мен өңдеу Қазақстандағы инфрақұрылымда жүзеге асады, қолжеткізу рөлдер мен аудандар бойынша шектелген.",
    "Модель — не «чёрный ящик»: по каждой оценке виден вклад каждого фактора, решение можно обосновать.":
    ...
    "Не папка бумаг, а объект в портале: аудит ПБ, план эвакуации, 2D/3D-планы и предиктивная риск-оценка. Конкуренты в РК делают это вручную — мы быстрее, нагляднее и с аналитикой, которой нет ни у кого.":
      "Қағаз папка емес, порталдағы нысан: ӨҚ аудиті, эвакуация жоспары, 2D/3D жоспарлар және болжамды тәуекел бағасы. ҚР-дағы бәсекелестер мұны қолмен жасайды — біз жылдамырақ, көрнекірек және ешкімде жоқ талдаумен жұмыс істейміз.",
    ...
    "Аудит пожарной безопасности и план эвакуации": "Өрт қауіпсіздігі аудиті және эвакуация жоспары",
    ...
    "Обсудить оцифровку вашего объекта": "Нысаныңызды цифрландыруды талқылау",
    ...
    "Аудит ПБ, документы и планы эвакуации без недель ручной работы подрядчика.":
      "ӨҚ аудиті, құжаттар мен эвакуация жоспарлары — мердігердің апталап қолмен жұмыс жасауынсыз.",
    ...
    "Цифровой паспорт закрывает первопричину: аудит находит нарушения до пожара, а риск-оценка показывает, какие объекты и системы требуют внимания в первую очередь.":
      "Цифрлық паспорт түпкі себепті жояды: аудит өрт шықпай тұрып бұзушылықтарды табады, ал тәуекел бағасы қай нысандар мен жүйелерге бірінші кезекте назар аудару керектігін көрсетеді.",
    ...
    "Аудит ПБ + план эвакуации + 2D/3D-планы + риск-оценка объекта.":
      "ӨҚ аудиті + эвакуация жоспары + 2D/3D жоспарлар + нысан тәуекел бағасы.",
    ...
    // ── "/login" ───────────────────────────────────────────────────────────
    "Предиктивная платформа · ДЧС РК": "Болжамды платформа · ҚР ТЖД",
    "Логин": "Логин",
    ...
    "Без обязательств · на реальных данных района, с обучением сотрудников":
      "Міндеттемесіз · аудан деректерінде, қызметкерлерді оқытумен",
    "Не папка бумаг, а объект в портале: аудит ПБ, план эвакуации, 2D/3D-планы и риск-оценка, которой нет ни у кого.":
      "Қағаз папка емес, порталдағы нысан: ӨҚ аудиті, эвакуация жоспары, 2D/3D жоспарлар және ешкімде жоқ тәуекел бағасы.",
