...
export const dict: { en: Record<string, string>; kk: Record<string, string> } = {
  en: {
    ...
    "Отчёт акиму и в маслихат — вручную из писем ДЧС": "Reports to the akim and the maslikhat — assembled by hand from ESD letters",
    ...
    "Что показать акиму и в маслихат?": "What to show the akim and the maslikhat?",
  ...
  kk: {
    ...
    "Отчёт акиму и в маслихат — вручную из писем ДЧС": "Әкімге және мәслихатқа есеп — ТЖД хаттарынан қолмен құрастырылады",
    "Сводка о пожарной безопасности района собирается вручную из переписки и служебных писем ДЧС — подготовка занимает дни, а актуальность данных не гарантирована.":
    ...
    "Что показать акиму и в маслихат?": "Әкімге және мәслихатқа нені көрсету керек?",
    "Печатная сводка на одну страницу A4: районы, показатели покрытия и приоритеты вложений — сохраняется как PDF прямо из браузера.":
