...
export const dict: { en: Record<string, string>; kk: Record<string, string> } = {
  en: {
    ...
    "и объяснимая оценка уязвимости": "and an explainable vulnerability score",
    ...
    "Ведомственная платформа пожарной безопасности с объяснимой оценкой уязвимости объектов для города и региона.":
      "A departmental fire-safety platform with an explainable facility vulnerability score, for the city and the region.",
    "Карта риска по всем зданиям города": "Risk map for every building in the city",
    "Инспекторам ДЧС — карта риска и маршруты по районам": "For ESD inspectors — a risk map and district routes",
    "Акимату — картина города по районам и приоритеты вложений": "For the akimat — a citywide picture by district and investment priorities",
    ...
    "Объяснимая оценка уязвимости объекта": "Explainable facility vulnerability score",
    ...
    // ── "/" modules section ───────────────────────────────────────────────
    "Предупреждение, надзор, реагирование — один контур": "Prevention, oversight, response — one loop",
    "Пульт диспетчера": "Dispatcher console",
    "Кого и чем направить на вызов?": "Who and what to send to the call?",
    "Регистрация вызова, наряд сил и техники, статусы подразделений и единая хронология выезда.": "Call intake, assignment of crews and vehicles, unit statuses and a single response timeline.",
    "Боевой выезд": "Fireground response",
    "Что известно об объекте по дороге?": "What do we know about the site en route?",
    "Оперкарточка в руках у РТП, расстановка сил на поэтажном плане, расчёт сил и средств по методике ДЧС, печатная форма донесения о пожаре.": "The operational card in the incident commander's hands, crew placement on the floor plan, force-and-means calculation per the emergency service methodology, and a printable fire incident report form.",
    "Кабинет собственника": "Owner portal",
    "Что устранить и до какого срока?": "What to fix, and by when?",
    "Владелец объекта видит свои нарушения, сроки и документы — предписания не теряются в переписке.": "The site owner sees their violations, deadlines and documents — orders no longer get lost in email threads.",
    ...
    "FireWatch собирает данные, оценивает риск и превращает оценку в конкретные задачи для инспекторов.":
      "FireWatch collects data, scores risk, and turns the score into concrete tasks for inspectors.",
    ...
    "гидранта в модели покрытия": "hydrants in the coverage model",
    "объекта с оцифрованными ПТП": "facilities with digitized fire plans",
    "помещение в 3D-двойниках": "rooms in 3D twins",
    "плана этажей оцифровано": "floor plans digitized",

    // ── "/" final CTA + footer ────────────────────────────────────────────
    "Покажем FireWatch на данных вашего региона": "We'll show FireWatch on your region's data",
    "Демо за 30 минут: карта риска, оценка модели, маршрут инспектора и 3D-двойник объекта на реальном городе.":
      "A 30-minute demo: risk map, model score, inspector route and a 3D facility twin on a real city.",
    "Без обязательств · 30 минут · на данных вашего региона": "No obligations · 30 minutes · on your region's data",
    "Пожарная безопасность и оценка уязвимости · МЧС РК · Астана": "Fire safety and vulnerability scoring · MES RK · Astana",
    ...
    "Оценка пожарной уязвимости": "Fire vulnerability score",
    ...
    // ── "/gov" akimat track ─────────────────────────────────────────────────
    "Для акимата": "For the akimat",
    "Выберите свою роль:": "Choose your role:",
    "Картина уязвимости по районам — без ручной сборки": "A district-by-district vulnerability picture — without manual assembly",
    "Городской трек платформы — агрегированная картина по районам вместо карточек объектов: для бюджетных решений и отчётности акима.":
      "The platform's city track — an aggregated picture by district instead of facility cards, for budget decisions and the akim's reporting.",
    "Нет единой картины уязвимости по районам": "No unified picture of vulnerability by district",
    "У акимата нет карты, где сразу видно, какие районы и объекты требуют внимания в первую очередь — только отдельные сводки от ДЧС.":
      "The akimat has no map that instantly shows which districts and facilities need attention first — only separate summaries from the ESD.",
    "Бюджет на гидранты и части — без карты покрытия": "Hydrant and station budgets — without a coverage map",
    "Заявки на новые гидранты и пожарные части формируются без единой картины «слепых зон» прибытия — сложно обосновать, где вложения дадут наибольший эффект.":
      "Requests for new hydrants and fire stations are drawn up without a unified picture of arrival blind spots — hard to justify where investment would have the biggest effect.",
    "Отчёт акиму и в облсобрание — вручную из писем ДЧС": "Reports to the akim and the regional assembly — assembled by hand from ESD letters",
    "Сводка о пожарной безопасности района собирается вручную из переписки и служебных писем ДЧС — подготовка занимает дни, а актуальность данных не гарантирована.":
      "The district fire-safety summary is assembled by hand from correspondence and official ESD letters — preparation takes days, and data freshness isn't guaranteed.",
    "Что получает акимат": "What the akimat gets",
    "Четыре экрана городского трека платформы — коротко, что даёт каждый.":
      "Four screens of the platform's city track — briefly, what each one delivers.",
    "Где смотреть в первую очередь?": "Where to look first?",
    "Районы ранжированы по вниманию: здания высокого риска в слепых зонах прибытия или без исправного гидранта в радиусе 800 м — видно сразу, без объезда районов.":
      "Districts are ranked by attention: high-risk buildings in arrival blind zones or without a working hydrant within 800 m — visible at a glance, no need to drive around every district.",
    "Как выглядит риск на карте?": "What does the risk look like on a map?",
    "Слои одной картой: районы, здания по оценке уязвимости, зона прибытия по нормативу 10 минут и слепые зоны, гидранты и пожарные части.":
      "Layers on one map: districts, buildings by vulnerability score, the 10-minute arrival zone and blind spots, hydrants and fire stations.",
    "Где гидрант или часть закроют больше риска?": "Where would a hydrant or station cover the most risk?",
    "Где новый гидрант или пожарная часть закрыли бы больше всего зданий высокого риска без покрытия — оценка по плотности, ориентир для выезда на обследование, а не готовое проектное решение.":
      "Where a new hydrant or fire station would cover the most uncovered high-risk buildings — a density estimate, a starting point for a field survey, not a finished design decision.",
    "Что показать акиму и в облсобрание?": "What to show the akim and the regional assembly?",
    "Печатная сводка на одну страницу A4: районы, показатели покрытия и приоритеты вложений — сохраняется как PDF прямо из браузера.":
      "A printable one-page A4 summary: districts, coverage indicators and investment priorities — saved as a PDF right from the browser.",
    "Только агрегаты — без персональных данных": "Aggregates only — no personal data",
    "Акимату доступно чтение районных показателей и зданий по оценке уязвимости — без персональных данных, донесений о происшествиях и карточек ПТП. Те же принципы разграничения по ролям, что и для остальных пользователей платформы.":
      "The akimat can only read district indicators and buildings by vulnerability score — no personal data, incident reports or fire-plan cards. The same role-based access rules apply as for every other platform user.",
    "Все цифры на этой странице — демонстрационные данные: риск-оценки рассчитаны на синтетических признаках и не отражают реальное состояние объектов, пока не подключены исторические данные ДЧС и реестр водоканала.":
      "Every number on this page is demo data: risk scores are computed on synthetic features and do not reflect the real condition of the buildings, until historical ESD data and the water utility's registry are connected.",
    "Приоритеты вложений — оценка по плотности объектов: ориентир для выезда на обследование, а не готовое проектное решение о размещении гидранта или части.":
      "Investment priorities are a density estimate: a starting point for a field survey, not a finished design decision on where to place a hydrant or a station.",
    "Как подключается акимат": "How an akimat connects",
    "Как городской трек платформы подключается к данным акимата — от границ районов до входа приоритетов в бюджетное планирование.":
      "How the platform's city track connects to the akimat's data — from district boundaries to priorities feeding into budget planning.",
    "Данные": "Data",
    "Границы районов и реестр гидрантов": "District boundaries and the hydrant registry",
    "Контуры районов (используем открытые границы OSM или ваши) и реестр гидрантов и пожарных частей — основа карты покрытия города.":
      "District boundaries (either open OSM data or your own) and the registry of hydrants and fire stations — the foundation of the city's coverage map.",
    "Карта": "Map",
    "Уязвимость на данных региона": "Vulnerability on your region's data",
    "Пересчёт оценки, зон прибытия и слепых зон на данных вашего региона — вместо демонстрационных данных на этой странице.":
      "Recalculating the score, arrival zones and blind spots on your region's data — instead of the demo data shown on this page.",
    "Отчётность": "Reporting",
    "Ежемесячный отчёт акиму": "A monthly report for the akim",
    "«Отчёт для акимата» каждый месяц: районы, покрытие и приоритеты вложений на одной странице — без ручной сборки из писем ДЧС.":
      "The \"Report for the akimat\" every month: districts, coverage and investment priorities on one page — no more manual assembly from ESD letters.",
    "Бюджет": "Budget",
    "Вход в планирование вложений": "Feeding into investment planning",
    "Приоритеты вложений — один из ориентиров при формировании заявки на гидранты и пожарные части, наравне с полевым обследованием.":
      "Investment priorities become one input when drafting the request for hydrants and fire stations — alongside the field survey.",
    "Что нужно от акимата: доступ к границам районов (свои контуры или открытые данные OSM), доступ к реестру гидрантов и пожарных частей, контактное лицо для согласования отчёта.":
      "What's needed from the akimat: access to district boundaries (your own contours or open OSM data), access to the hydrant and fire-station registry, a point of contact to sign off on the report.",
    ...
    "Объяснимая оценка уязвимости объекта — с разбором факторов риска":
      "Explainable facility vulnerability score — with a risk-factor breakdown",
    ...
    // ── "/login" ───────────────────────────────────────────────────────────
    "Платформа пожарной безопасности · МЧС РК": "Fire-safety platform · MES RK",
    "Логин": "Username",
    ...
    "Оценка и объяснение": "Score and explanation",
    ...
    "FireWatch превращает бумажный план тушения в интерактивный 3D-двойник, оценивает риск каждого здания и показывает, какие объекты проверять в первую очередь.":
      "FireWatch turns a paper fire suppression plan into an interactive 3D twin, scores the risk of every building, and shows which facilities to inspect first.",
    "Пилот в Астане · оценка уязвимости объектов": "Pilot in Astana · facility vulnerability scoring",
    ...
    "FireWatch оценивает риск каждого из ~250 000 зданий и превращает оценку в маршруты инспекций и карту «слепых зон» прибытия.":
      "FireWatch scores the risk of each of ~250,000 buildings and turns the score into inspection routes and a map of arrival blind spots.",
    "Без обязательств · на реальных данных района, с обучением сотрудников":
      "No obligations · on the district's real data, with staff training",
    "Не папка бумаг, а объект в портале: план эвакуации, 2D/3D-планы и объяснимая оценка уязвимости.":
      "Not a folder of papers, but a facility in a portal: evacuation plan, 2D/3D plans, and an explainable vulnerability score.",
    ...
    "ИИ-извлечение и 2D/3D-планы · объяснимая оценка уязвимости объекта":
      "AI extraction and 2D/3D plans · explainable facility vulnerability score",
  ...
  kk: {
    ...
    "и объяснимая оценка уязвимости": "және түсіндірілетін осалдықты бағалау",
    ...
    "Ведомственная платформа пожарной безопасности с объяснимой оценкой уязвимости объектов для города и региона.":
      "Нысандардың осалдығын түсіндірмелі бағалайтын, қала мен өңірге арналған өрт қауіпсіздігінің ведомстволық платформасы.",
    "Карта риска по всем зданиям города": "Қаланың барлық ғимараттары бойынша тәуекел картасы",
    "Инспекторам ДЧС — карта риска и маршруты по районам": "ТЖД инспекторларына — тәуекел картасы және аудандар бойынша бағыттар",
    "Акимату — картина города по районам и приоритеты вложений": "Әкімдікке — аудандар бойынша қала көрінісі және инвестиция басымдықтары",
    ...
    "Объяснимая оценка уязвимости объекта": "Нысанның осалдығын түсіндірмелі бағалау",
    ...
    // ── "/" modules section ───────────────────────────────────────────────
    "Предупреждение, надзор, реагирование — один контур": "Алдын алу, қадағалау, ден қою — бір контур",
    "Пульт диспетчера": "Диспетчер пульті",
    "Кого и чем направить на вызов?": "Шақыруға кімді және немен жіберу керек?",
    "Регистрация вызова, наряд сил и техники, статусы подразделений и единая хронология выезда.": "Шақыруды тіркеу, күштер мен техниканы жіберу, бөлімшелер мәртебесі және шығудың біртұтас хронологиясы.",
    "Боевой выезд": "Өрт сөндіру шығуы",
    "Что известно об объекте по дороге?": "Жолда нысан туралы не белгілі?",
    "Оперкарточка в руках у РТП, расстановка сил на поэтажном плане, расчёт сил и средств по методике ДЧС, печатная форма донесения о пожаре.": "Жедел карта ӨСБ қолында, күштерді қабат жоспарында орналастыру, ТЖД әдістемесі бойынша күштер мен құралдарды есептеу, өрт туралы баянаттың басып шығарылатын нысаны.",
    "Кабинет собственника": "Меншік иесінің кабинеті",
    "Что устранить и до какого срока?": "Нені және қай мерзімге дейін жою керек?",
    "Владелец объекта видит свои нарушения, сроки и документы — предписания не теряются в переписке.": "Нысан иесі өз бұзушылықтарын, мерзімдерін және құжаттарын көреді — нұсқамалар хат алмасуда жоғалмайды.",
    "Каждый закрывает свою боль ведомства и работает с общими данными.":
    ...
    "FireWatch собирает данные, оценивает риск и превращает оценку в конкретные задачи для инспекторов.":
      "FireWatch деректерді жинайды, тәуекелді бағалайды және бағаны инспекторларға арналған нақты тапсырмаларға айналдырады.",
    ...
    "Оценка уязвимости": "Осалдықты бағалау",
    "Модель XGBoost оценивает каждое здание по 30+ признакам: материал, возраст, этажность, инциденты рядом, сезон. SHAP объясняет каждую оценку.":
    ...
    "гидранта в модели покрытия": "қамту моделіндегі гидрант",
    "объекта с оцифрованными ПТП": "цифрландырылған ӨСЖ-і бар нысан",
    "помещение в 3D-двойниках": "3D-егіздердегі бөлме",
    "плана этажей оцифровано": "цифрландырылған қабат жоспары",

    // ── "/" final CTA + footer ────────────────────────────────────────────
    "Покажем FireWatch на данных вашего региона": "FireWatch-ты өз өңіріңіздің деректерінде көрсетеміз",
    "Демо за 30 минут: карта риска, оценка модели, маршрут инспектора и 3D-двойник объекта на реальном городе.":
      "30 минуттық демо: тәуекел картасы, модель бағасы, инспектор бағыты және нақты қаладағы нысанның 3D-егізі.",
    "Без обязательств · 30 минут · на данных вашего региона": "Міндеттемесіз · 30 минут · өз өңіріңіздің деректерінде",
    "Пожарная безопасность и оценка уязвимости · МЧС РК · Астана": "Өрт қауіпсіздігі және нысанның осалдығын бағалау · ҚР ТЖМ · Астана",
    ...
    "Оценка пожарной уязвимости": "Өрт осалдығын бағалау",
    ...
    // ── "/gov" akimat track ─────────────────────────────────────────────────
    "Для акимата": "Әкімдікке",
    "Выберите свою роль:": "Рөліңізді таңдаңыз:",
    "Картина уязвимости по районам — без ручной сборки": "Аудандар бойынша осалдық көрінісі — қолмен жинамай-ақ",
    "Городской трек платформы — агрегированная картина по районам вместо карточек объектов: для бюджетных решений и отчётности акима.":
      "Платформаның қалалық трегі — нысан карточкалары емес, аудандар бойынша жиынтық көрініс: әкімнің бюджеттік шешімдері мен есептілігі үшін.",
    "Нет единой картины уязвимости по районам": "Аудандар бойынша осалдықтың тұтас көрінісі жоқ",
    "У акимата нет карты, где сразу видно, какие районы и объекты требуют внимания в первую очередь — только отдельные сводки от ДЧС.":
      "Әкімдікте қай аудандар мен нысандарға бірінші кезекте назар аудару керектігін бірден көрсететін карта жоқ — тек ТЖД-ден бөлек жинақтар ғана бар.",
    "Бюджет на гидранты и части — без карты покрытия": "Гидранттар мен бөлімдерге бюджет — қамту картасынсыз",
    "Заявки на новые гидранты и пожарные части формируются без единой картины «слепых зон» прибытия — сложно обосновать, где вложения дадут наибольший эффект.":
      "Жаңа гидранттар мен өрт сөндіру бөлімдеріне өтінімдер келудің «соқыр аймақтары» жайлы тұтас көріністі ескермей жасалады — қаражатты қайда салған тиімдірек екенін негіздеу қиын.",
    "Отчёт акиму и в облсобрание — вручную из писем ДЧС": "Әкімге және облыстық жиналысқа есеп — ТЖД хаттарынан қолмен құрастырылады",
    "Сводка о пожарной безопасности района собирается вручную из переписки и служебных писем ДЧС — подготовка занимает дни, а актуальность данных не гарантирована.":
      "Аудан бойынша өрт қауіпсіздігі жинағы хат-хабар мен ТЖД қызметтік хаттарынан қолмен құрастырылады — дайындау бірнеше күнге созылады, ал деректердің өзектілігіне кепілдік жоқ.",
    "Что получает акимат": "Әкімдік не алады",
    "Четыре экрана городского трека платформы — коротко, что даёт каждый.":
      "Платформаның қалалық трегінің төрт экраны — әрқайсысы не беретіні қысқаша.",
    "Где смотреть в первую очередь?": "Бірінші кезекте қайда қарау керек?",
    "Районы ранжированы по вниманию: здания высокого риска в слепых зонах прибытия или без исправного гидранта в радиусе 800 м — видно сразу, без объезда районов.":
      "Аудандар назар бойынша сараланған: келу соқыр аймақтарындағы немесе 800 м радиуста жұмыс істейтін гидранты жоқ жоғары тәуекелді ғимараттар — аудандарды аралап шықпай-ақ бірден көрінеді.",
    "Как выглядит риск на карте?": "Тәуекел картада қалай көрінеді?",
    "Слои одной картой: районы, здания по оценке уязвимости, зона прибытия по нормативу 10 минут и слепые зоны, гидранты и пожарные части.":
      "Бір картадағы қабаттар: аудандар, осалдық бағасы бойынша ғимараттар, 10 минуттық норматив бойынша келу аймағы мен соқыр аймақтар, гидранттар мен өрт сөндіру бөлімдері.",
    "Где гидрант или часть закроют больше риска?": "Гидрант немесе бөлім қай жерде көбірек тәуекелді жабады?",
    "Где новый гидрант или пожарная часть закрыли бы больше всего зданий высокого риска без покрытия — оценка по плотности, ориентир для выезда на обследование, а не готовое проектное решение.":
      "Жаңа гидрант немесе өрт сөндіру бөлімі қамтылмаған жоғары тәуекелді ғимараттардың көбін қай жерде жабатыны — тығыздық бойынша баға, далалық тексеруге шығуға арналған бағдар, дайын жобалық шешім емес.",
    "Что показать акиму и в облсобрание?": "Әкімге және облыстық жиналысқа нені көрсету керек?",
    "Печатная сводка на одну страницу A4: районы, показатели покрытия и приоритеты вложений — сохраняется как PDF прямо из браузера.":
      "Бір беттік A4 басып шығарылатын жинақ: аудандар, қамту көрсеткіштері және инвестиция басымдықтары — браузерден тікелей PDF ретінде сақталады.",
    "Только агрегаты — без персональных данных": "Тек жиынтық көрсеткіштер — дербес деректерсіз",
    "Акимату доступно чтение районных показателей и зданий по оценке уязвимости — без персональных данных, донесений о происшествиях и карточек ПТП. Те же принципы разграничения по ролям, что и для остальных пользователей платформы.":
      "Әкімдікке тек аудандық көрсеткіштер мен осалдық бағасы бойынша ғимараттарды оқуға рұқсат етілген — дербес деректерсіз, оқиға туралы хабарламалар мен ӨСЖ карточкаларынсыз. Платформаның басқа пайдаланушылары үшін де сол рөлдер бойынша шектеу қағидаттары қолданылады.",
    "Все цифры на этой странице — демонстрационные данные: риск-оценки рассчитаны на синтетических признаках и не отражают реальное состояние объектов, пока не подключены исторические данные ДЧС и реестр водоканала.":
      "Бұл беттегі барлық сандар — демо деректер: тәуекел бағалары синтетикалық белгілер бойынша есептелген және ТЖД тарихи деректері мен су құбыры тізілімі қосылғанға дейін ғимараттардың нақты жай-күйін көрсетпейді.",
    "Приоритеты вложений — оценка по плотности объектов: ориентир для выезда на обследование, а не готовое проектное решение о размещении гидранта или части.":
      "Инвестиция басымдықтары — нысандар тығыздығы бойынша баға: далалық тексеруге шығуға арналған бағдар, гидрантты немесе бөлімді орналастыру туралы дайын жобалық шешім емес.",
    "Как подключается акимат": "Әкімдік қалай қосылады",
    "Как городской трек платформы подключается к данным акимата — от границ районов до входа приоритетов в бюджетное планирование.":
      "Платформаның қалалық трегі әкімдіктің деректеріне қалай қосылады — аудан шекараларынан бастап басымдықтардың бюджеттік жоспарлауға енуіне дейін.",
    "Данные": "Деректер",
    "Границы районов и реестр гидрантов": "Аудан шекаралары және гидранттар тізілімі",
    "Контуры районов (используем открытые границы OSM или ваши) и реестр гидрантов и пожарных частей — основа карты покрытия города.":
      "Аудан контурлары (ашық OSM деректері немесе өзіңіздікі) және гидранттар мен өрт сөндіру бөлімдерінің тізілімі — қаланың қамту картасының негізі.",
    "Карта": "Карта",
    "Уязвимость на данных региона": "Өңір деректеріндегі осалдық",
    "Пересчёт оценки, зон прибытия и слепых зон на данных вашего региона — вместо демонстрационных данных на этой странице.":
      "Бағаны, келу аймақтары мен соқыр аймақтарды осы беттегі демо деректердің орнына өз өңіріңіздің деректерінде қайта есептеу.",
    "Отчётность": "Есептілік",
    "Ежемесячный отчёт акиму": "Әкімге ай сайынғы есеп",
    "«Отчёт для акимата» каждый месяц: районы, покрытие и приоритеты вложений на одной странице — без ручной сборки из писем ДЧС.":
      "«Әкімдікке арналған есеп» әр ай сайын: аудандар, қамту және инвестиция басымдықтары бір бетте — ТЖД хаттарынан қолмен құрастырмай-ақ.",
    "Бюджет": "Бюджет",
    "Вход в планирование вложений": "Инвестицияларды жоспарлауға енгізу",
    "Приоритеты вложений — один из ориентиров при формировании заявки на гидранты и пожарные части, наравне с полевым обследованием.":
      "Инвестиция басымдықтары — гидранттар мен өрт сөндіру бөлімдеріне өтінім жасаған кезде далалық тексерумен қатар қолданылатын бағдарлардың бірі.",
    "Что нужно от акимата: доступ к границам районов (свои контуры или открытые данные OSM), доступ к реестру гидрантов и пожарных частей, контактное лицо для согласования отчёта.":
      "Әкімдіктен не қажет: аудан шекараларына қолжеткізу (өз контурлары немесе ашық OSM деректері), гидранттар мен өрт сөндіру бөлімдері тізіліміне қолжеткізу, есепті келісуге байланыс тұлғасы.",
    ...
    "Объяснимая оценка уязвимости объекта — с разбором факторов риска":
      "Нысанның осалдығын түсіндірмелі бағалау — тәуекел факторларының талдауымен",
    ...
    // ── "/login" ───────────────────────────────────────────────────────────
    "Платформа пожарной безопасности · МЧС РК": "Өрт қауіпсіздігі платформасы · ҚР ТЖМ",
    "Логин": "Логин",
    ...
    "Оценка и объяснение": "Баға және түсіндірме",
    ...
    // ── landing de-slop pass: trimmed hero/strip/CTA copy ─────────────────
    "FireWatch превращает бумажный план тушения в интерактивный 3D-двойник, оценивает риск каждого здания и показывает, какие объекты проверять в первую очередь.":
      "FireWatch қағаз түріндегі өрт сөндіру жоспарын интерактивті 3D-егізге айналдырады, әрбір ғимараттың тәуекелін бағалайды және қай нысандарды бірінші кезекте тексеру керектігін көрсетеді.",
    "Пилот в Астане · оценка уязвимости объектов": "Астанадағы пилот · нысандардың осалдығын бағалау",
    "Без обязательств · демо 30 минут на данных вашего региона":
      "Міндеттемесіз · өз өңіріңіздің деректеріндегі 30 минуттық демо",
    "FireWatch оценивает риск каждого из ~250 000 зданий и превращает оценку в маршруты инспекций и карту «слепых зон» прибытия.":
      "FireWatch шамамен 250 000 ғимараттың әрқайсысының тәуекелін бағалайды және бағаны тексеру бағыттары мен келудің «соқыр аймақтары» картасына айналдырады.",
    "Без обязательств · на реальных данных района, с обучением сотрудников":
      "Міндеттемесіз · аудан деректерінде, қызметкерлерді оқытумен",
    "Не папка бумаг, а объект в портале: план эвакуации, 2D/3D-планы и объяснимая оценка уязвимости.":
      "Қағаз папка емес, порталдағы нысан: эвакуация жоспары, 2D/3D жоспарлар және түсіндірмелі осалдық бағасы.",
    "Независимый аудит в области пожарной безопасности проводит аккредитованная экспертная организация-партнёр (аккредитация КЧС МВД РК, Закон РК «О гражданской защите»). FireWatch выполняет цифровую часть: планы, документы, паспорт объекта и риск-оценку.":
    ...
    "ИИ-извлечение и 2D/3D-планы · объяснимая оценка уязвимости объекта":
      "ЖИ көмегімен алу және 2D/3D жоспарлар · нысанның түсіндірмелі осалдық бағасы",
