...
export const dict: { en: Record<string, string>; kk: Record<string, string> } = {
  en: {
    ...
    "и оценка уязвимости": "and a vulnerability score",
    "— какие объекты проверять в первую очередь": "— which facilities to inspect first",
  ...
  kk: {
    ...
    "и оценка уязвимости": "және осалдықты бағалау",
    "— какие объекты проверять в первую очередь": "— қай нысандарды бірінші кезекте тексеру керек",
    "FireWatch превращает бумажный план тушения в интерактивный 3D-двойник, оценивает риск каждого здания и объясняет почему — чтобы ДЧС действовал на опережение, а не постфактум.":
