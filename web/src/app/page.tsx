...
const STATS: { n: number; l: string }[] = [
  ...
  { n: 1134, l: "гидранта в модели покрытия" },
  { n: 3, l: "объекта с оцифрованными ПТП" },
  { n: 81, l: "помещение в 3D-двойниках" },
  { n: 23, l: "плана этажей оцифровано" },
];
...
const TRUST: { icon: LucideIcon; label: string }[] = [
  ...
  { icon: Lock, label: "Готово к размещению в РК" },
];
...
const FORK: {
...
}[] = [
  {
    ...
    sub: "Ведомственная платформа пожарной безопасности с объяснимой оценкой уязвимости объектов для города и региона.",
    bullets: [
      "Инспекторам ДЧС — карта риска и маршруты по районам",
      "Акимату — картина города по районам и приоритеты вложений",
      "Журнал аудита, маскирование ПДн, размещение в РК",
    ],
  ...
  },
  {
    ...
    bullets: [
      "План эвакуации, документы ПБ и 2D/3D-планы",
      "ИИ-извлечение из документов за минуты",
      "Объяснимая оценка уязвимости объекта",
    ],
...
export default function Landing() {
  ...
  const navLinks: NavLink[] = [
    ...
    { href: "/gov", label: t("Для ДЧС и акиматов") },
    ...
    <div className="min-h-screen bg-bg text-fg">
      ...
      <Section id="numbers">
        <div className="rounded-xl border border-border bg-surface p-7 shadow-card sm:p-9">
          <div className="text-[12.5px] font-medium text-muted">
            {t("Пилот в Астане · оценка уязвимости объектов")}
          </div>
      ...
      <Section id="modules">
        <Reveal>
          <SectionHead
            center
            title={t("Предупреждение, надзор, реагирование — один контур")}
      ...
      <LandingFooter tagline={t("Пожарная безопасность и оценка уязвимости · МЧС РК · Астана")} />
    </div>
  );
}
