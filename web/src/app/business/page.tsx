...
const INCLUDES: string[] = [
  "План эвакуации и пакет документов по пожарной безопасности",
...
const AUDIENCE: { icon: LucideIcon; title: string; text: string }[] = [
  ...
  { icon: Briefcase, title: "Офисы и бизнес-центры", text: "Документы и планы эвакуации без недель ручной работы подрядчика." },
...
const PRICING: {
...
}[] = [
  {
    ...
    what: "План эвакуации + 2D/3D-планы + риск-оценка + портал объекта.",
    price: "от 150 000 ₸",
    ...
    <div className="min-h-screen bg-bg text-fg">
          ...
          <div className="grid grid-cols-1 items-center gap-10 rounded-xl border border-border bg-surface p-7 shadow-card lg:grid-cols-[1.1fr_.9fr] lg:p-11 [&>div]:min-w-0">
            ...
            <div className="rounded-xl border border-border bg-surface-2 p-4">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-[11.5px] text-faint">
                ...
                <span className="inline-flex items-center gap-1.5">
                  <ShieldCheck className="h-3.5 w-3.5" aria-hidden /> {t("Документы ПБ")}
                </span>
                <span className="inline-flex items-center gap-1.5">
      ...
      <div>
        <Section id="pricing">
          ...
          <p className="mx-auto mt-3 max-w-[680px] text-center text-[12.5px] leading-relaxed text-faint">
            {t(
        ...
        <Reveal>
          <div className="relative mx-auto max-w-[1180px] overflow-hidden rounded-xl border border-border bg-surface px-6 py-16 text-center shadow-card sm:px-12">
            ...
            <p className="relative mt-4 text-[13px] text-faint">
              {t("ИИ-извлечение и 2D/3D-планы · объяснимая оценка уязвимости объекта")}
            </p>
          </div>
        </Reveal>
      </section>
